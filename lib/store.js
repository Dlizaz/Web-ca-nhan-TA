...
const DEFAULT_SETTINGS = {
  ...
  usernameSparkleColor: '#ff5c9a', // màu kim tuyến quanh tên
  sparkleCursorColor: '#7c5cff',   // màu kim tuyến theo con trỏ chuột
  sparklePageColor: '#ff5c9a',     // màu kim tuyến rải khắp trang (ambient)
  // Code cấu hình JSON (tsParticles) tự dán riêng cho từng loại kim tuyến, để trống = dùng hiệu ứng tự chế + màu tương ứng ở trên
  sparkleCursorConfig: '',   // riêng cho kim tuyến theo con trỏ chuột
  usernameSparkleConfig: '', // riêng cho kim tuyến quanh tên
  pageParticlesConfig: '',   // riêng cho kim tuyến rải khắp trang
  ...
  discordManualAvatar: '',
  discordMarqueeSpeed: 18, // tốc độ chạy chữ dòng trạng thái Discord, đơn vị px/giây (số càng lớn chạy càng nhanh)
